...
#define STRING_CONFIG_H_AUTHOR "(Fuad, Simple Azteeg X3 v2)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 1.1.9 // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 Printrbot v1         // will be shown during bootup in line 2
